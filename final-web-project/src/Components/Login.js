...
const User = () => {
    return (
        <div className="flex flex-wrap justify-center rounded-xl h-96 bg-white max-h-72 p-5 w-60 tablet:w-80">
            ...
            <div className="flex items-center mb-2 w-full">
                <FaLock size={20} />
                <input type="password" placeholder="Password" className="rounded-lg ml-2 p-2 text-lg w-full" required />
            </div>
            <div>
